...
Decision = Literal[
    "stay", "go_to_clarify", "go_to_research", "go_to_summarize", "go_to_design", "go_to_finalize"
]
...
async def route(
    ...
    *,
    ...
    try:
        ...
        reason = d.get("reason", "")
        valid_decisions = {
            "stay", "go_to_clarify", "go_to_research",
            "go_to_summarize", "go_to_design", "go_to_finalize",
        }
